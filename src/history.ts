...
function setupWorkoutCard(workoutCard: HTMLElement) {
  const summaryCard = workoutCard.querySelector('.workout-summary') as HTMLElement;
  const DetailsExpanded = workoutCard.querySelector('.workout-details') as HTMLElement;
