...
export const EXERCISE_FORM_CONTAINER = document.getElementById('exercise-form-container') as HTMLElement | null;
...
export const HISTORY_CONTAINER = document.getElementById('workouts-history-container') as HTMLElement | null;
