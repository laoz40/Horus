...
export function updateWorkoutButtons() {
    if (isInEditMode()) {
        ...
        BACK_BUTTON_WORKOUT && (BACK_BUTTON_WORKOUT.classList.add("danger-secondary"),
            BACK_BUTTON_WORKOUT.classList.remove("secondary"),
            BACK_BUTTON_WORKOUT.textContent = "Discard");
        FINISH_WORKOUT_BUTTON && (FINISH_WORKOUT_BUTTON.textContent = "Save");
    }
    else {
        // else revert buttons
        BACK_BUTTON_WORKOUT && (BACK_BUTTON_WORKOUT.classList.remove("danger-secondary"),
            BACK_BUTTON_WORKOUT.classList.add("secondary"),
            BACK_BUTTON_WORKOUT.textContent = "Back");
        FINISH_WORKOUT_BUTTON && (FINISH_WORKOUT_BUTTON.textContent = "Finish");
    }
}
